...
Recent versions contain optional AI-assisted features that utilize GPT-4 or other Large Language Models to help explore, analyse, and interact with data in innovative ways. Familiarise yourself with new data by [exploring broad topics or concepts](https://qualcoder-org.github.io/en/5.1.-AI-chat-based-analysis#topic-analysis-chat) in an interactive chat with the AI. Dive deeper into specific aspects with [AI-assisted coding](https://qualcoder-org.github.io/en/4.2.-AI-Assisted-Coding) and [text analysis](https://qualcoder-org.github.io/en/5.1.-AI-chat-based-analysis#text-analysis-chat). And if you reach the point where you must synthesize and consolidate your results, [discuss them in a code chat](https://qualcoder-org.github.io/en/5.1.-AI-chat-based-analysis#code-analysis-chat) with the AI.
...
[Page on how to work as a team with QualCoder](https://qualcoder-org.github.io/en/2.4.-Working-in-a-Team)
